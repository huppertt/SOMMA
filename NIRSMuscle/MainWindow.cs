...
public partial class MainWindow : Gtk.Window
{
    ...
    public MainWindow() : base(Gtk.WindowType.Toplevel)
    {
        ...
        MyData = new List<double>[18];
        for (int i = 0; i < 18; i++)
        {
            MyData[i] = new List<double>();
        }
    ...
    public void SaveMyData(string filename)
    {
        ...
        for (int i=0; i<n; i++)
        {
            ...
            _Det1b[i] = MyData[8][i];
            _Det2b[i] = MyData[9][i];
            _Det3b[i] = MyData[10][i];
            _Det4b[i] = MyData[11][i];
    ...
    protected void updateData()
    {
        ...
        while (mainthread.IsAlive)
        {
            ...
            if (msgss.Length > 3)
            {
                MyData[3].Add(Convert.ToDouble(msgss[0]) / 1000);  // time-NIRS
                MyData[4].Add(Convert.ToDouble(msgss[2]));  // Det1a
                MyData[5].Add(Convert.ToDouble(msgss[3]));  // Det2a
                MyData[6].Add(Convert.ToDouble(msgss[4]));  // Det3a
                MyData[7].Add(Convert.ToDouble(msgss[5]));  // Det4a

                MyData[8].Add(Convert.ToDouble(msgss[6]));  // Det1b
                MyData[9].Add(Convert.ToDouble(msgss[7]));  // Det2b
                MyData[10].Add(Convert.ToDouble(msgss[8]));  // Det3b
                MyData[11].Add(Convert.ToDouble(msgss[9]));  // Det4b

                MyData[12].Add(Convert.ToDouble(msgss[10]));  // dODa
                MyData[13].Add(Convert.ToDouble(msgss[11]));  // dODb

                MyData[14].Add(Convert.ToDouble(msgss[12]));  // HbO
                MyData[15].Add(Convert.ToDouble(msgss[13]));  // HbR
                MyData[16].Add(Convert.ToDouble(msgss[14]));  // HbT
                MyData[17].Add(Convert.ToDouble(msgss[15]));  // SO2
